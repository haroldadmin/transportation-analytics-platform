...
X=read("/home/divyakshi/Documents/Food_deliveryX.csv")
Y=read("/home/divyakshi/Documents/Food_deliveryY.csv")
...
plt.scatter(HighX,HighY,color="Red",label="High",edgecolors="Black")
plt.xlabel("Longitude")
plt.ylabel("Latitude")
plt.title("FOOD DELHIVERY\nSuggested Zones for Business Expansion")
plt.legend()
plt.grid(True)
